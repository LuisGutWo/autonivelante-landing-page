            ...
            <Container fluid className="d-flex justify-content-center p-0 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1000ms">
                <article className="postcard p_relative">
                    ...
                    >
                        ...
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_01.jpg)" }}></SwiperSlide>
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_02.jpg)" }}></SwiperSlide>
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_04.jpg)" }}></SwiperSlide>
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_05.jpg)" }}></SwiperSlide>
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_06.jpg)" }}></SwiperSlide>
                        <SwiperSlide className="postcard__img" style={{ backgroundImage: "url(assets/images/banner/carrusel-home_08.jpg)" }}></SwiperSlide>
                    </Swiper>


                    <div className="postcard__text">
                        <h1 className="postcard__title blue text-light text-start">
                            <Link href="#">Conoce Nuestros
                                <br />Servicios
                            </Link>
                        </h1>
                        <div className="postcard__bar"></div>
                        <div className="postcard__preview-txt">
                            Expertos en superficies, al igual que en aplicación de autonivelantes cementicios, Nivelación y afinado de losa, sobrelosas, retape, reparación de fisuras y superficies.
                            <br />
                            <br />
                            ...
                            <Row>
                                ...
                                <Col>
                                    <div className="postcard__content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                        </svg> <p className="text-light">Sobrelosas</p>
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                <Col>
                                    <div className="postcard__content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                        </svg> <p className="text-light">Afinado de Losas</p>
                                    </div>
                                </Col>
                                <Col>
                                    <div className="postcard__content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                        </svg> <p className="text-light">Retape</p>
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                <Col>
                                    <div className="postcard__content">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                        </svg> <p className="text-light">Reparación de Fisuras</p>
                                    </div>
                                </Col>
                            </Row>
                        </Container>
