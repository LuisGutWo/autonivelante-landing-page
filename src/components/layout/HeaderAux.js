    ...
    return (
        <>
            <header className={`main-header header-style-three2 ${scroll ? "fixed-header2" : ""}`}>
                        ...
                        <div className="outer-box">
                            ...
                            <ul className="menu-right-content">
                                <li className="cart-box">
                                    <Link href="/#contact" onClick={handleShowCartSend}>
                ...
                {/* Sticky Header */}
                <div className={`sticky-header2 ${scroll ? "animated slideInDown" : ""}`}>
                        ...
                        <div className="outer-box">
                            ...
                            <div className="menu-area2 clearfix">
                                <nav className="main-menu2 navbar-expand-md navbar-light">
                                    <div className="collapse navbar-collapse show clearfix text-light" id="navbarSupportedContent">
                                        <Menu />
                                    </div>
                                </nav>
                            </div>
