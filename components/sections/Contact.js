                                ...
                                <div className="contactcard image-box p_relative d-flex flex-wrap flex-row">
                                    ...
                                    <div className="contactcard__text">
                                        <div className="contactcard__text-inner">
                                            ...
                                            <Container fluid className="mb-5 text-start pt-0 pe-3 pb-0 ps-3">
                                                <Row>
                                                    <Col>
                                                        <div className="contactcard__content d-flex flex-row align-items-start" >
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" className="bi bi-phone mt-2" viewBox="0 0 16 16">
                                                ...
                                                <Row>
                                                    <Col>
                                                        <div className="contactcard__content d-flex flex-row align-items-start">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-geo-alt mt-2" viewBox="0 0 16 16">
                                                ...
                                                <Row>
                                                    <Col>
                                                        <div className="contactcard__content-tree d-flex flex-row align-items-start">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" spacing="10" fill="currentColor" className="bi bi-clock mt-3" viewBox="0 0 16 16">
                                                        ...
                                                        <div className="form-inner">
                                                            <Form ref={form} onSubmit={sendEmail} id="contact-form">
                                                                ...
                                                                <Button onClick={handleShowEmailSend} className="theme-btn theme-btn-one" style={{ width: "100%", marginTop: "4rem" }} value="Send" type="submit" name="submit-form">Enviar mensaje
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-arrow-right-short" style={{ marginLeft: "1rem" }} viewBox="0 0 16 16">
                                                                        <path fillRule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8" />
                                                                    </svg></Button>
                                                                <Modal show={showEmailSend} onHide={handleCloseEmailSend}>
                                                                    <Modal.Header closeButton>
                                                                        <Modal.Body>
                                                                            Correo Enviado!<br /> Te responderemos a la brevedad.
                                                                            Gracias
                                                                        </Modal.Body>
                                                                    </Modal.Header>
                                                                </Modal>
                                    ...
                                    <section className="social__icons">
                                        ...
                                        <Link href="https://web.facebook.com/profile.php?id=100088723373843" className="contact__links">
                                            <div className="social__icons-inner d-flex justify-content-center align-items-center">
