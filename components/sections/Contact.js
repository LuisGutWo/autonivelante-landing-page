                                    ...
                                    <div className="contactcard__text">
                                        <div class="contactcard__text-inner">
                                            ...
                                            <Container fluid className="mb-5 text-start pt-0 pe-3 pb-0 ps-3">
                                                <Row>
                                                    <Col>
                                                        <div className="contactcard__content d-flex flex-row align-items-start" >
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-phone mt-2" viewBox="0 0 16 16">
                                                ...
                                                <Row>
                                                    <Col>
                                                        <div class="contactcard__content d-flex flex-row align-items-start">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-geo-alt mt-2" viewBox="0 0 16 16">
                                                ...
                                                <Row>
                                                    <Col>
                                                        <div class="contactcard__content-tree d-flex flex-row align-items-start">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" spacing="10" fill="currentColor" class="bi bi-clock mt-3" viewBox="0 0 16 16">
