            ...
            <Container>
                <section className="mainfeat-section p_relative">
                    <div className="bg-layer wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1000ms" style={{ backgroundColor: "#015c93" }}>
                        ...
                        <p className="text-light fs-6">El autonivelante está diseñado para la instalación de recubrimientos de alfombras, pisos vinílicos, de madera, flotantes, y de goma.
                            <br />
                            <br />
                        Es utilizado principalmente para la nivelación reparación y afinado de losas, sobrelosas, radieres y pisos de concreto.</p>
                    </div>
                                ...
                                <div className="content_block_two">
                                    <div className="content-box p_relative p-0">
                                        <div className="featcard__text">
                                            <h1 className="featcard__title blue text-dark text-start fw-bold">Características
                                                <br />
                    ...
                    <div className="outer-box wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1000ms">
                        ...
                        <div className="mainfeat__bar"></div>
                        <p className="text-dark">Cargas desde 3 mm hasta 30 mm de espesor en una sola aplicación; tomando en cuenta las especificaciones de cada  producto.</p>
