                        ...
                        <div className="detailproducts__card-maincontent">
                            ...
                            >
                                <div className="detailcard-body">
                                    ...
                                    <ul>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2 "><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" className="bi bi-circle-fill" viewBox="0 0 16 16">
