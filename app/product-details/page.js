    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={2}>
                <section class="maincard__section">
                    <Container className="detailproducts__card-box">
                        <div class="detailproducts__card-maincontent">
                            <div
                            ...
                            >
                                <div className="detailcard-body">
                                    ...
                                    <h5 className="detailproductcard-subtitle pb-4">Mortero                               Autonivelante</h5>
                                    <ul>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2 "><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Autonivelante</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Fácil preparación y colocación</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Alta estabilidad dimensional y durabilidad</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Acabado liso y fino acompañado de alta resistencia final</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Alta trabajabilidad y rendimiento</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">No sufre retracciones hasta el espesor máximo indicado</p>
                                        </li>
                                        <li className="list__item d-flex flex-row justify-content-start align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="5" height="5" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
                                            <circle cx="8" cy="8" r="8" />
                                        </svg>
                                            <p className="fs_11">Uso exclusivo para superficies interiores</p>
                                        </li>
                                    </ul>
                                    <div className="detailcard-price fw-bold">$ 16.500</div>
                                    <div class="buttons__card d-flex flex-column">
