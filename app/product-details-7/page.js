            ...
            <div className="detailproducts__card-maincontent">
              ...
              <div className="card detailmain__card">
                <div className="detailcard-body">
                  <h4 className="fw-bold pb-3">{productsListPage[3].name}</h4>
                  <h5 className="fs_11 fw-bold mb-2">
                    {productsListPage[3].subtitle}
                  </h5>
                  <br />
                  <p className="fs_11">{productsListPage[3].desc}</p>
                  <br />
                  <p className="fs_11">{productsListPage[3].desc2}</p>
                  <br />
                  <p className="fs_11">{productsListPage[3].desc3}</p>
                  <div className="detailcard-price fw-bold">
                    {productsListPage[3].price}
                  </div>
