...
const caracteristicas = [
  {
    id: 0,
    name: "Para el tratamiento de superficies de yeso, antes de la colocación de cerámicos y porcelanatos.",
  },
  {
    id: 1,
    name: "Como capa de anclaje para revoques proyectados de base yeso.",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    name: "Para mejorar la adhesión de la capa de enlucido sobre superficies cementicias o de anhidrita, o superficies a base de yeso.",
  },
  {
    id: 4,
    name: "Para regular la absorción de superficies cementicias o de yeso.",
  },
];
            ...
            <div className="detailproducts__card-maincontent">
              ...
              <div className="card detailmain__card">
                <div className="detailcard-body">
                  <h4 className="fw-bold pb-3">{productsListPage[4].name}</h4>
                  <h5 className="fs_11 fw-bold mb-2">
                    {productsListPage[4].subtitle}
                  </h5>
                  <br />
                  <p className="fs_11">{productsListPage[4].desc}</p>
                  <br />
                  <p className="fs_11">{productsListPage[4].desc2}</p>
