...
const caracteristicas = [
  {
    id: 0,
    name: "Exclusivo: Uso interior",
  },
  {
    id: 1,
    name: "espesores de 3 a 40 mm",
  },
  {
    id: 2,
    name: "Transitable a las 3 hrs / Bombeable.",
  },
  {
    id: 3,
    name: "PRESENTACIÓN: bolsas de 20 kg.",
  },
];
            ...
            <div className="detailproducts__card-maincontent">
              ...
              <div className="card detailmain__card">
                <div className="detailcard-body">
                  <h4 className="fw-bold pb-3">{productsListPage[6].name}</h4>
                  <h5 className="fs_11 fw-bold mb-2">
                    {productsListPage[6].subtitle}
                  </h5>
                  <br />
                  <p className="fs_11">{productsListPage[6].desc}</p>
