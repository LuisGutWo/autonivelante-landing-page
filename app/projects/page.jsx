...
const projects = [
    {
        ...
        duration: '15 días',
        year: '2022',
        description: 'Aplicación de Autonivelante en toda la superficie, instalacion de alfombra y Piso Vinilico LVT.',
        thumbnail: '/assets/images/projects/thumbnail.png',
        images: [
            '/assets/images/projects/gallery_demo.png',
            '/assets/images/projects/gallery_demo.png',
        ],
    },
    {
        ...
        duration: '5 días',
        year: '2022',
        description: 'Aplicación de Autonivelante en toda la superficie a instalar pavimentos. Instalacion de Piso Vinilico.',
        thumbnail: '/assets/images/projects/thumbnail.png',
        images: [
            '/assets/images/projects/gallery_demo.png',
            '/assets/images/projects/gallery_demo.png',
...
const SlideNavigation = (props) => {
    ...
    return <div {...otherProps} className={`${className} ${styles.project__item__gallery}`} />;
}
                        ...
                        <div key={i} className={styles.projects__item}>
                            <div className="row align-items-center">
                                <div className={`col-12 col-sm-6 ${ i % 2 ? 'order-sm-2' : ''}`}>
                                    ...
                                    <div className="mt-5">
                                        <p><strong>Nombre proyecto:</strong> { item.name }</p>
                                        <p><strong>Metros cuadrados:</strong> { item.mt2 } m2</p>
                                        <p><strong>Tiempo ejecución:</strong> { item.duration }</p>
